...
/**
 * Render one field row according to its schema-driven type. We keep the
 * `unknown`-cast surface narrow — every union arm explicitly coerces to the
 * shape the matching `<input>` expects.
 */
function FieldRow({
  kind,
  field,
